...
function createListContainer(list) {
    ...
    li.innerHTML = `
        <a href="${list.live}" class="all__projects-list-img-link" target="blank">
    ...
    listSub.innerHTML = `
        <h3>${list.name}</h3>
        <div>
            <a data-link="github" href="${githubRep}" target="blank">
            ...
            <a data-link="live" href="${list.live}" target="blank">
                <figure aria-hidden="true">
